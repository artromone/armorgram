 ...
 */
package com.armorgram.feature.main
...
import com.armorgram.common.androidxcompat.drawerOpen
import com.armorgram.common.base.QkThemedActivity
import com.armorgram.common.util.extensions.autoScrollToStart
import com.armorgram.common.util.extensions.dismissKeyboard
import com.armorgram.common.util.extensions.resolveThemeColor
import com.armorgram.common.util.extensions.scrapViews
import com.armorgram.common.util.extensions.setBackgroundTint
import com.armorgram.common.util.extensions.setTint
import com.armorgram.common.util.extensions.setVisible
import com.armorgram.feature.blocking.BlockingDialog
import com.armorgram.feature.changelog.ChangelogDialog
import com.armorgram.feature.conversations.ConversationItemTouchCallback
import com.armorgram.feature.conversations.ConversationsAdapter
...
class MainActivity : QkThemedActivity(), MainView {
    ...
    override fun render(state: MainState) {
        ...
        // Minimal build: no QKSMS Plus upsell, no rating prompt — keep them hidden.
        listOf(plusBadge1, plusBadge2).forEach { badge -> badge.isVisible = false }
